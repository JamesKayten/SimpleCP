...
```bash
# Check AI communications first
ls docs/ai_communication/
# Or for OCC-specific: ls docs/occ_communication/
...
```bash
# For projects with ai_communication folder
ls -la docs/ai_communication/

# For projects with occ_communication folder
ls -la docs/occ_communication/
```

### "check for violations" / "check for reports"
**Action**: Look for reports from local AI
```bash
# General AI reports
ls -la docs/ai_communication/AI_REPORT_*.md | tail -1

# OCC-specific violation reports
...
Customize this section with project-specific commands and workflows.

### Example Project Commands
```bash
# Add your project-specific verbal command mappings here
# Example: "run tests" → npm test
# Example: "check build" → npm run build
```

## Framework Version
**Version**: 1.1
**Last Updated**: Auto-generated during installation
