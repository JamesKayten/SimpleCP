...
- Check with: `find . -name "*.py" -o -name "*.js" -o -name "*.java" | xargs wc -l | awk '$1 > 250 {print "VIOLATION: " $2 " has " $1 " lines (limit: 250)"}'`
...
**Parameters**: File size: 250 lines, Coverage: 90%, Tools: black,flake8,pytest
